...
$ helm repo update
$ helm install stash-mongodb-v2020.11.06 appscode/stash-mongodb -n kube-system --version=v2020.11.06
```
...
To install the chart with the release name `stash-mongodb-v2020.11.06`:
...
To uninstall/delete the `stash-mongodb-v2020.11.06`:

```console
$ helm delete stash-mongodb-v2020.11.06 -n kube-system
```
...
| image.tag        | Tag of the image that is used to backup/restore MongoDB database. This is usually same as the database version it can backup. | `v2020.11.06`   |
...
```console
$ helm install stash-mongodb-v2020.11.06 appscode/stash-mongodb -n kube-system --version=v2020.11.06 --set image.registry=stashed
```
...
```console
$ helm install stash-mongodb-v2020.11.06 appscode/stash-mongodb -n kube-system --version=v2020.11.06 --values values.yaml
```
