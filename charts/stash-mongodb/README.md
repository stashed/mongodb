...
$ helm repo update
$ helm install stash-mongodb-v2020.07.09-beta.0 appscode/stash-mongodb -n kube-system --version=v2020.07.09-beta.0
```
...
To install the chart with the release name `stash-mongodb-v2020.07.09-beta.0`:
...
To uninstall/delete the `stash-mongodb-v2020.07.09-beta.0`:

```console
$ helm delete stash-mongodb-v2020.07.09-beta.0 -n kube-system
```
...
```console
$ helm install stash-mongodb-v2020.07.09-beta.0 appscode/stash-mongodb -n kube-system --version=v2020.07.09-beta.0 --set image.registry=stashed
```
...
```console
$ helm install stash-mongodb-v2020.07.09-beta.0 appscode/stash-mongodb -n kube-system --version=v2020.07.09-beta.0 --values values.yaml
```
