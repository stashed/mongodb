...
$ helm repo update
$ helm install stash-mongodb-3.4.2-beta.20200708 appscode/stash-mongodb -n kube-system --version=3.4.2-beta.20200708
```
...
To install the chart with the release name `stash-mongodb-3.4.2-beta.20200708`:
...
To uninstall/delete the `stash-mongodb-3.4.2-beta.20200708`:

```console
$ helm delete stash-mongodb-3.4.2-beta.20200708 -n kube-system
```
...
```console
$ helm install stash-mongodb-3.4.2-beta.20200708 appscode/stash-mongodb -n kube-system --version=3.4.2-beta.20200708 --set image.registry=stashed
```
...
```console
$ helm install stash-mongodb-3.4.2-beta.20200708 appscode/stash-mongodb -n kube-system --version=3.4.2-beta.20200708 --values values.yaml
```
