...
$ helm repo update
$ helm install stash-mongodb-3.4.2-beta.20200709 appscode/stash-mongodb -n kube-system --version=3.4.2-beta.20200709
```
...
To install the chart with the release name `stash-mongodb-3.4.2-beta.20200709`:
...
To uninstall/delete the `stash-mongodb-3.4.2-beta.20200709`:

```console
$ helm delete stash-mongodb-3.4.2-beta.20200709 -n kube-system
```
...
```console
$ helm install stash-mongodb-3.4.2-beta.20200709 appscode/stash-mongodb -n kube-system --version=3.4.2-beta.20200709 --set image.registry=stashed
```
...
```console
$ helm install stash-mongodb-3.4.2-beta.20200709 appscode/stash-mongodb -n kube-system --version=3.4.2-beta.20200709 --values values.yaml
```
