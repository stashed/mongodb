...
To install the chart with the release name `stash-mongodb-3.6.13`:
...
To uninstall/delete the `stash-mongodb-3.6.13`:

```console
$ helm delete stash-mongodb-3.6.13 -n kube-system
```
...
```console
$ helm install stash-mongodb-3.6.13 appscode/stash-mongodb -n kube-system --version=3.6.13 --set image.registry=stashed
```
...
```console
$ helm install stash-mongodb-3.6.13 appscode/stash-mongodb -n kube-system --version=3.6.13 --values values.yaml
```
